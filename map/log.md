...
## [2026-09-08] ingest | ChatGPT Work 증강·자동화·조직화

- [[library/notes/증강-자동화-조직화]] (원본 `_archive/`) · 감수 대기 0→1건

## [2026-09-08] daily | 화

- Home「사서 제안」· [[map/daily/2026-09-08]]
- 하이라이트: 오전 1인기업 조직도 · 오후 가을을 느끼기 — 편집장 문장 그대로 정식
- 구글 캘린더 당일분만: 글쓰기 09–12 → `1인기업 조직도 설계` · 자전거 13:30–17 → `가을을 느끼기` (반복 시리즈는 그대로)
- Tasks는 이 환경에 도구가 없어 못 넣음

## [2026-09-08] conversation | 1인기업 창설

- 조직화 실제 구현. 금주 하이라이트 = 1인기업 창설. 본체=윈도우 데스크탑 · 챗지피티. 사서=기록
- [[library/projects/1인기업]] · [[conversations/2026-09-08-1인기업-창설]] · [[map/weekly/2026-09-W1]]

## [2026-09-08] 결정 | 문지방은 저녁 독서

- 금주 하이라이트(1인기업)와 섞지 않음. 당일 독서 인스턴스만 `문지방` (반복 시리즈는 그대로)

## [2026-09-09] 정식 | 증강·자동화·조직화

- [[library/notes/증강-자동화-조직화]] `[x] 감수` → `status: final`

## [2026-09-09] conversation | 오소풍 AI Studio 창립

- 내부 창설·가동 준비 완료. 창립일 2026-09-09. 법률·세무상 사업체 아님
- 조직: 대표 오소풍 · 기획 ChatGPT · 출판 커스 · 수묵캘리 캘리 · AI제품 코덱스 · 조사·운영 헤르메스(수동 인계)
- 남은 행정: 헤르메스 수동 인계 PR
- [[library/projects/1인기업]] · [[conversations/2026-09-09-오소풍-AI-Studio-창립]] · [[map/daily/2026-09-09]]

## [2026-09-09] ingest | ChatGPT 공유 링크
...
## [2026-09-10] 정리 | 드라이브 「오소풍 AI Studio」 산출물 폴더

- 편집장 지시 — 오늘 회사 산출물(책 1장 완성·2장 초고 / 감성폭발 앱 완성 / 사랑 시화 1편 완성) 드라이브에 깨끗이 정리
- Drive `오소풍 AI Studio/` 신설 → 책 · 시화 · 앱 세 칸 (+책/편지 원고) · 문서 8개 배치 · 편지 docx 3개는 `내 컴퓨터/Downloads`에서 이동 · vFlat 스캔 폴더 → 「하림 생일 캘리 편지 스캔」 개명·이동
- 루트의 개인 사진(IMG_*)·`오늘 볼 것`(헤르메스 큐레이션)은 회사 산출물이 아니라 손대지 않음
- [[오소풍 AI Studio/운영내력]] 9/10 내력 append · [[오소풍 AI Studio/_index]]에 Drive 폴더 링크 추가

## [2026-09-12] pull | 헤르메스 inbox

- `d7ed954` inbox: 김현승 눈물 요약 (Hermes). 로컬 운영내력 커밋과 갈라져 `git pull --rebase`

## [2026-09-12] 정식 | `[x] 감수` 2건

- [[library/projects/1인기업]] · [[오소풍 AI Studio/_index]] → `status: final`

## [2026-09-12] ingest | 김현승 「눈물」

- [[library/notes/김현승-눈물]] (원본 `_archive/김현승-눈물-요약`) · 감수 대기 6→5건 (정식 2 · ingest 1)

## [2026-09-12] daily | 토

- Home「사서 제안」· [[map/daily/2026-09-12]]
- 하이라이트: 오전 사진수채화 앱 완성 · 오후 책 3장 쓰기 — (초안)
- 구글 캘린더 당일분만: 글쓰기 09–12 → `사진수채화 앱 완성` · 자전거 13:30–17 → `책 3장 쓰기` (반복 시리즈는 그대로)
- Tasks는 이 환경에 도구가 없어 못 넣음
...
## [2026-09-12] 유튜브 | 클로드 코드 실무편 스크립트·코덱스 비교

- 지시: `inbox/무제` 링크 스크립트 추출 · 코덱스와 비교해 핵심 정리
- [[_archive/youtube-클로드코드-실무편-스크립트]] (오늘 쓰는 AI · 13:26 · 자동자막)
...
## [2026-09-13] weekly | 2026-09-W1 채움

- [[map/weekly/2026-09-W1]] (9/7–13) · 주중 뼈대 → 가치 있는 일 6 · 프로젝트 3칸 · A–D 제안 · 스킬 후보 1 (공장 미병합 가지)
- inbox 유튜브 3건(`AI 뚝딱` · `지식인사이드` · `무제`)은 지시 대기

## [2026-09-13] weekly | 2026-09-W1 요일별 교정

- 편집장: 가치 있는 일은 **요일을 맨 앞에**. 월 = 프롬프트 대시보드 완성 · AI Agent 팀으로 1인기업 구상. 금 = 책 2장 「능소화편지」 완성
- 화·수·목·토는 장부·daily로 채움. 일 = 한 주 갈무리
- [[오소풍]] 가족 에세이 2장 정식 · [[오소풍 AI Studio/운영내력]] 9/11 append

## [2026-09-13] purpose | 논지 7
...
## [2026-09-13] 말투 | 문단·번호 간격

- 편집장: 표·한 덩어리 금지. 문단과 번호는 줄 간격을 띄워 일목요연하게.

## [2026-09-13] calendar | 다음 주 계획 당일분만

- 9/14–20: 오전 글쓰기 → 책 1장 쓰기 · 오후 운동자리 → 캘리 1편
- 저녁 독서: 월·화 사진수채화 · 수–금 청풍갤러리. 토·일은 독서 유지
- 반복 시리즈·월요일 캘리수업·잠·식사는 그대로

## [2026-09-16] 정식 | `[x] 감수` 3건

- [[library/notes/김현승-눈물]] · [[library/notes/유튜브-제미나이-신기능-10가지]] · [[library/notes/유튜브-유영만-유능함의-덫]] → `status: final`
- 감수 대기 6→3건 (스크립트 3건 남음)

## [2026-09-16] daily | 수 · 어제 책 3장

- 편집장: 어제(화 9/15) 책 3장 「오소풍 AI Studio 창립 이야기」 완성
- [[오소풍]] · [[오소풍 AI Studio/운영내력]] 9/15 · [[map/daily/2026-09-16]]
- inbox `AI 뚝딱`은 지시 대기

## [2026-09-17] daily | 목

- 오늘은 9/17 (목). 어제(수) daily를 오늘처럼 쓰지 않음. 날짜 옆에 요일.
- [[map/daily/2026-09-17]] · 채팅 링크 `[오늘의 daily (YYYY-MM-DD 요일)]` · AGENTS·[[오소풍]] 말투

## [2026-09-17] 기록 | 어제 책 4장

- 편집장: 어제(수 9/16) 책 4장 「나의 애마 ‘소풍’ 자전거」 완성
- [[오소풍]] · [[오소풍 AI Studio/운영내력]] 9/16 · [[map/daily/2026-09-16]]
- essays 파일은 아직 git에 넣지 않음

## [2026-09-17] ★5 | 헤르메스 봇팀

- 편집장: 「헤르메스 봇팀」제목으로 5스타
