...
디지털 책과 원본 자료는 먼저 **Zotero에 그대로 보관**한다. 원본 전체를 LLM 위키에 복사하지 않는다.
...
그다음 오소풍에게 필요한 결과만 추려서 LLM 위키 `inbox/`에 기록한다.
...
- [[_archive/원본은-Zotero에-액기스는-LLM-위키에|원본]]
- [[library/notes/ChatGPT-대화를-Zotero로]]
